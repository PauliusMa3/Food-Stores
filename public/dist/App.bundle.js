...
function ajaxHearts(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        ...
        (0, _bling.$)('.heart-count').textContent = res.data.length;
    }).catch(console.error);
}

exports.default = ajaxHearts;
...
function loadPlaces(map) {
    ...
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -79.86;
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        var markers = res.data.map(function (place) {
  ...
  searchInput.on("input", function () {
    ...
    axios.get("/api/search?q=" + this.value).then(function (res) {
      if (res.data.stores.length) {
        var html = createHtml(res.data.stores);
...
var heartForms = (0, _bling.$$)('button.heart__button');
